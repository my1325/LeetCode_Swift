...
class Solution {
    ...
    func constructMaximumBinaryTree(_ nums: [Int], _ begin: Int, _ end: Int) -> TreeNode? {
        guard end - begin > 0 else { return nil }

        let maxIndex = findMax(nums, begin, end)
    ...
    func findMax(_ nums: [Int], _ begin: Int, _ end: Int) -> Int {
        guard end - begin > 0 else { return begin }
